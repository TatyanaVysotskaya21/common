...
def test_number_letter_a_in_str():
    input_str = 'I am a good developer. I am also a writer'
    assert number_letter_a_in_str(input_str, 'a') == 5
...
def test_arithmetic_progression():
    ...
    assert arithmetic_progression(list_progression)
...
def test_count_elements_until_tuple():
    ...
    assert count_elements_until_tuple(list_input) == 4


def test_string_reversed_order():
